...
def on_subscribe(client, userdata, flags, rc):
    global topic_results, is_connect, username
...
def on_message(client, userdata, msg):
    ...
    topic_results[msg.topic].append(mission_id)
...
def worker(_username, _behavier, _id):
    ...
    while i < len(behavier):
        ...
        elif action == 'start' and behavier[i - 1]['api'] == 'start':
            if (fetch):
