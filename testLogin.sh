...
# Step2 
# Run the script to test Login Logoutpython app/utils/create_time.py -f testLogin  # 重新設定測項 Json 檔內容
cp app/env_template.py app/env.py
sed -i 's/test.json/testLogin.json/' app/env.py # 設定要執行的 Json 檔名
